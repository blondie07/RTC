...
// cause par 1 wakeup line (interne ou externe) (le NVIC n'est plus alimente)
...
// le contenu de la RAM et des registres etant preserve, le MPU
// reprend l'execution apres l'instruction WFI
void RTC_wakeup_init_from_stop( int delay )
{
	RTC_wakeup_init( delay );
	// valider l'interrupt par la ligne 20 du module EXTI, qui est reservee au wakeup timer
